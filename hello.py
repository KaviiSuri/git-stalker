...
def fetch_github_data(url: str, headers: dict) -> dict:
...
def track_activity(
    ...
    start_date: Optional[str] = Option(None, "--start-date", help="Start date in YYYY-MM-DD format"),
    end_date: Optional[str] = Option(None, "--end-date", help="End date in YYYY-MM-DD format"),
